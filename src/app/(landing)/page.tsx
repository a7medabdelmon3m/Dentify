          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-11 mt-25 ">
              ...
              <div className="col-span-4 md:col-span-3 space-y-11">
                <p className="text-center font-light text-4xl text-text-black">
                  Submit dental case through a well-organized system that
                  ensures accurate case review ,appropriate treatment, and
                  matching with nearby dental students based on your geographic
                  location.
                </p>
                <Link
                  href={"/about"}
                  className="flex gap-3.5 bg-primary-subtle text-[#1877F2] text-4xl font-light text-center w-fit mx-auto"
                >
            ...
            <div className="grid grid-cols-4 gap-11 mt-25">
              ...
              <div className="col-span-4 md:col-span-3 space-y-11">
                <p className="text-center font-light text-4xl text-text-black">
                  Access real patient cases through an organized system that
                  saves time, ensures accurate case selection, and helps you
