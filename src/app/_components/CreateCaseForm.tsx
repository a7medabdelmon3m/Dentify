        ...
        <div className="bg-white rounded-xl p-4 shadow-sm space-y-10">
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              ...
              >
                <Textarea
                  className="border border-border-main h-auto rounded-2xl py-3 px-8 shadow-[0px_20px_50px_0px_#BF156C0D] focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/20 min-h-30"
                  {...field}
          ...
          <Button
            type="button"
            className="bg-primary hover:bg-primary-hover text-white w-full rounded-2xl py-3 h-auto font-bold"
          >
            {t("submitBtn")}
          </Button>
        </div>
            ...
            render={({ field: { onChange, value } }) => (
              <div className="flex flex-col gap-4">
                ...
                {value && value.length > 0 && (
                  <label
                    htmlFor="xRay"
                    className="text-center text-sm text-gray-500 underline cursor-pointer hover:text-primary"
                  >
                    {t("changePhoto")}
                  </label>
                )}
