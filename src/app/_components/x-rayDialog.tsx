...
export function XRayDialog({ isOpen, setIsOpen, imageSrc, analysisText }: XRayDialogProps) {
  const t = useTranslations('CreateCase.XRayDialog');
  
  const previewUrl = imageSrc instanceof FileList ? URL.createObjectURL(imageSrc[0]) : imageSrc;
