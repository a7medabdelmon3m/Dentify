...
interface Appointment {
  ...
  studentName: string;
  location: string;
  status: "Confirmed" | "PendingAcceptance" | "Cancelled";
...
export default function AppointmentSelectionCard({
  ...
  // استخراج اسم الدكتور من أول موعد (لأنه ثابت لكل المواعيد لنفس الحالة)
  ...
  const handleConfirm = () => {
    ...
    // هنا هتنادي على الـ API عشان تأكد الموعد
  };
  ...
  return (
    <div className="space-y-6 rounded-3xl border border-border-light bg-white p-6 shadow-md text-rightAr">
      ...
      {/* 1. بانر الطبيب المعالج (ثابت فوق المواعيد) */}
      ...
      {/* 2. قائمة المواعيد القابلة للاختيار (أصبحت أنظف وأخف) */}
